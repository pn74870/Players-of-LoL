...
public abstract class Utilities {
    ...
    public static String matchType(String type, String subtype, String mode, int queueConfigId) {
        if (subtype.equals("")) { //possibly update of this list will be needed
            switch (queueConfigId) {
                ...
                case 14:
                    return "NORMAL 5x5 DRAFT";
                case 4:
                    return "RANKED SOLO 5x5";
                case 6:
                    return "RANKED PREMADE 5x5*";
                case 9:
                    return "RANKED PREMADE 3x3*";
                case 41:
                    return "RANKED TEAM 3x3";
                case 42:
                    return "RANKED TEAM 5x5";
                case 16:
                    return "ODIN 5x5 BLIND";
                case 17:
                    return "ODIN 5x5 DRAFT";
                case 7:
                    return "BOT 5x5*";
                case 25:
                    return "BOT ODIN 5x5";
                case 31:
                    return "BOT 5x5 INTRO";
                case 32:
                    return "BOT 5x5 BEGINNER";
                case 33:
                    return "BOT 5x5 INTERMEDIATE";
                case 52:
                    return "BOT TT 3x3";
                case 61:
                    return "GROUP FINDER 5x5";
                case 65:
                    return "ARAM 5x5";
                case 70:
                    return "ONEFORALL 5x5";
                case 72:
                    return "FIRSTBLOOD 1x1";
                case 73:
                    return "FIRSTBLOOD 2x2";
                case 75:
                    return "SR 6x6";
                case 76:
                    return "URF 5x5";
                case 83:
                    return "BOT URF 5x5";
                case 91:
                    return "NIGHTMARE BOT 5x5 RANK1";
                case 92:
                    return "NIGHTMARE BOT 5x5 RANK2";
                case 93:
                    return "NIGHTMARE BOT 5x5 RANK5";
                case 96:
                    return "ASCENSION 5x5";
                case 98:
                    return "HEXAKILL";
                case 100:
                    return "BILGEWATER ARAM 5x5";
                case 300:
                    return "KING PORO 5x5";
                case 310:
                    return "COUNTER PICK";
                case 313:
                    return "BILGEWATER 5x5";
        ...
        public void onResponse(JSONObject response) {
            ...
            if (spells != null) {
                ...
                while (keys.hasNext()) {
                    ...
                    if (getStringFromJson(spell, "key").equals(id + ""))
                        name = getStringFromJson(spell, "id");
